/**
 * Phase 7: research 20 upcoming football events and write yield artifacts.
...
async function main() {
  ...
  const outDir = join(process.cwd(), "artifacts", "phase-7");
  mkdirSync(outDir, { recursive: true });
  writeFileSync(join(outDir, "data-yield-report.json"), JSON.stringify({ at: nowIso, runtime: ANALYSIS_RUNTIME_VERSION, research: result, yield: yieldSum, events }, null, 2));
  writeFileSync(
