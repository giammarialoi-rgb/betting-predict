"""TASK 029 — multi-book T-1h overlay from the same BeatTheBookie dump used by TASK 027/028.

Does NOT rewrite strict-candidates.csv.
Reads frozen match_id list from that file and emits every valid 1X2 book at PHP bin 70 (hours_before=1).
"""
...
OUTDIR = os.path.join(ROOT, "audit", "external", "task-029")
OUT = os.path.join(OUTDIR, "books-t1h.csv")
