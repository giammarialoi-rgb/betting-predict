...
const CATEGORIES: Record<string, SourceCategory[]> = {
  ...
  "open-meteo": ["WEATHER"],
  thesportsdb: ["EVENT_DISCOVERY", "RESULTS_HISTORY", "FORM", "LINEUPS"],
  wikipedia: ["RESULTS_HISTORY", "FORM"],
  "bbc-sport": ["EVENT_DISCOVERY"],
  gazzetta: ["EVENT_DISCOVERY"],
  ansa: ["EVENT_DISCOVERY"],
  "sky-sport": ["EVENT_DISCOVERY"],
